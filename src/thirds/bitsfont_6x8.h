#ifndef AIRDUNIO_THIRD_BITFONT_6X8

#define AIRDUNIO_THIRD_BITFONT_6X8 1

// Come from https://github.com/idispatch/raster-fonts

const unsigned char BITFONT_6X8_ASCII[]PROGMEM = {
